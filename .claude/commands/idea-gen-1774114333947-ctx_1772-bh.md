...
## Target Context
- Context ID: ctx_1772272173342_facad0i
- Context Name: Character Blueprint
...
**Context Description**:
Character base class hierarchy with component slots, input bindings, movement profiles, and class radar chart visualization.

**Files in this Context** (14 files):
- src/components/modules/core-engine/unique-tabs/CharacterBlueprint.tsx
...

{
  ...
  "project_id": "0e9d4601-bf8c-43fe-b3e7-e0e9e2598b32",
  "context_id": "ctx_1772272173342_facad0i",
  "scan_type": "bug_hunter",
  "category": "<category>",
  "title": "<title>",
