...
Analyze the **studio-story** codebase at **C:\Users\kazda\kiro\studio-story** and create/update intelligent, structure-based contexts in the SQLite database.

## Project Information

- **Project ID**: 0e9d4601-bf8c-43fe-b3e7-e0e9e2598b32
- **Project Name**: studio-story
- **Project Path**: C:\Users\kazda\kiro\studio-story
- **Project Type**: nextjs
- **Scan Timestamp**: 2026-02-27T18-05-57
...
- `PROJECT_PATH` → C:\Users\kazda\kiro\studio-story
...
```bash
curl -X GET "http://localhost:3000/api/contexts?projectId=0e9d4601-bf8c-43fe-b3e7-e0e9e2598b32"
```
...
find "C:\Users\kazda\kiro\studio-story/src/app" -maxdepth 1 -type d -name "*-page" 2>/dev/null
find "C:\Users\kazda\kiro\studio-story/src/app/features" -maxdepth 1 -type d -name "sub_*" 2>/dev/null
```

### 3. Read High-Level Architecture (Optional)

```bash
cat "C:\Users\kazda\kiro\studio-story/context/high.md" 2>/dev/null || echo "No high-level architecture file found"
```
...
mkdir -p "C:\Users\kazda\kiro\studio-story/docs/contexts"

# Generate the report
cat > "C:\Users\kazda\kiro\studio-story/docs/contexts/scan-report-2026-02-27T18-05-57.md" << 'EOF'
# Context Scan Report

**Date**: 2026-02-27T18-05-57
**Project**: studio-story
**Project ID**: 0e9d4601-bf8c-43fe-b3e7-e0e9e2598b32
...
C:\Users\kazda\kiro\studio-story/docs/contexts/scan-report-2026-02-27T18-05-57.md
