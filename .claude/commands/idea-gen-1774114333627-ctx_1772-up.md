...
## Target Context
- Context ID: ctx_1772272194701_yvocesd
- Context Name: Dodge Timeline Editor
...
**Context Description**:
Design dodge mechanics timelines with i-frame windows, cancel windows, cooldown phases, stamina costs, and dodge chain visualization.

**Files in this Context** (10 files):
- src/components/modules/core-engine/unique-tabs/DodgeTimelineEditor.tsx
...

{
  ...
  "project_id": "0e9d4601-bf8c-43fe-b3e7-e0e9e2598b32",
  "context_id": "ctx_1772272194701_yvocesd",
  "scan_type": "ui_perfectionist",
  "category": "<category>",
  "title": "<title>",
