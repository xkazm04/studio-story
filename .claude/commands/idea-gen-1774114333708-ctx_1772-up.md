...
## Target Context
- Context ID: ctx_1772272218268_61vlea5
- Context Name: GAS Balance Simulator
...
**Context Description**:
Run combat balance simulations testing stat scaling, DPS, TTK, armor mitigation, and sensitivity analysis across player/enemy configurations.

**Files in this Context** (13 files):
- src/components/modules/core-engine/unique-tabs/GASBalanceSimulator.tsx
...
- C:/Users/kazda/Documents/Unreal Projects/PoF/Source/PoF/AbilitySystem/ARPGAttributeSet.h
- C:/Users/kazda/Documents/Unreal Projects/PoF/Source/PoF/AbilitySystem/ARPGAttributeSet.cpp
...
Found 1 active idea(s) (9 total, excluding rejected/implemented for brevity):

### Accepted Ideas (1)
1. **Sensitivity chart interactive hover with value readout** (ui)
   - The SensitivityChart SVG (lines 493-557) renders static circles on data points with no hover interaction. Add onMouseMove tracking that finds the near...
...

{
  ...
  "project_id": "0e9d4601-bf8c-43fe-b3e7-e0e9e2598b32",
  "context_id": "ctx_1772272218268_61vlea5",
  "scan_type": "ui_perfectionist",
  "category": "<category>",
  "title": "<title>",
