...
## Target Context
- Context ID: ctx_1772272211921_9uhzfg9
- Context Name: GAS Blueprint Editor
...
**Context Description**:
Edit GAS attributes, gameplay effect definitions, tag blocking/cancel rules, and ability loadout slot configurations.

**Files in this Context** (11 files):
- src/components/modules/core-engine/unique-tabs/GASBlueprintEditor.tsx
...

{
  ...
  "project_id": "0e9d4601-bf8c-43fe-b3e7-e0e9e2598b32",
  "context_id": "ctx_1772272211921_9uhzfg9",
  "scan_type": "bug_hunter",
  "category": "<category>",
  "title": "<title>",
