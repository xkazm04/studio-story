...
## Target Context
- Context ID: ctx_1772272290074_nwkxxsm
- Context Name: Progression Curve
...
**Context Description**:
Design level progression with XP curves, multi-curve overlays for HP/Mana/Damage/EnemyHP, build path presets, and attribute scaling visualization.

**Files in this Context** (13 files):
- src/components/modules/core-engine/unique-tabs/ProgressionCurve.tsx
...
- C:/Users/kazda/Documents/Unreal Projects/PoF/Source/PoF/Player/ARPGPlayerCharacter.h
- C:/Users/kazda/Documents/Unreal Projects/PoF/Source/PoF/Player/ARPGPlayerCharacter.cpp
...
- C:/Users/kazda/Documents/Unreal Projects/PoF/Source/PoF/AbilitySystem/Effects/GE_AwardXP.cpp
...
Found 1 active idea(s) (6 total, excluding rejected/implemented for brevity):

### Accepted Ideas (1)
1. **Attribute Point Optimizer (PoB-Style Build Planner)** (functionality)
   - Add a Path of Building-style attribute point optimizer. Given a target build (e.g. maximize DPS, maximize survivability, balance crit+mana), compute t...
...

{
  ...
  "project_id": "0e9d4601-bf8c-43fe-b3e7-e0e9e2598b32",
  "context_id": "ctx_1772272290074_nwkxxsm",
  "scan_type": "bug_hunter",
  "category": "<category>",
  "title": "<title>",
