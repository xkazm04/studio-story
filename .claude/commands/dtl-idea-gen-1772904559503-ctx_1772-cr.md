...
## Target Context
- Context ID: ctx_1772216022960_j8dbpeg
- Context Name: Theme & Narrative Analysis
...
**Context Description**:
Manage story themes, track thematic elements across scenes, analyze narrative analytics with engagement simulation, flow analysis, and character arc tracking. Build and evaluate thematic consistency.

**Files in this Context** (10 files):
- src/app/features/story/components/ThemeManager.tsx
- src/app/features/story/components/ThematicAnalysis.tsx
- src/app/features/story/components/NarrativeAnalyticsDashboard.tsx
- src/workspace/panels/story/ThemeManagerPanel.tsx
- src/lib/analytics/CharacterArcAnalyzer.ts
- src/lib/analytics/EngagementSimulator.ts
- src/lib/analytics/FlowSimulator.ts
- src/lib/analytics/ThematicAnalyzer.ts
- src/lib/themes/ThemeTracker.ts
- src/workspace/panels/story/StoryEvaluatorPanel.tsx
...

{
  ...
  "project_id": "0e9d4601-bf8c-43fe-b3e7-e0e9e2598b32",
  "context_id": "ctx_1772216022960_j8dbpeg",
