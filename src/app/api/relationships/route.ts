 ...
 */
export const GET = withApiHandler('GET /api/relationships', async (request: NextRequest) => {
 ...
 */
export const POST = withApiHandler('POST /api/relationships', async (request: NextRequest) => {
