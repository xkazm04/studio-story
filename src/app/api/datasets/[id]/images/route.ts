...
export const GET = withApiHandler('GET /api/datasets/[id]/images', async (_request: NextRequest, context: RouteContext) => {
...
export const POST = withApiHandler('POST /api/datasets/[id]/images', async (request: NextRequest, context: RouteContext) => {
  const { id } = await context.params;
