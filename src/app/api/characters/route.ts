 ...
 */
export const GET = withApiHandler('GET /api/characters', async (request: NextRequest) => {
 ...
 */
export const POST = withApiHandler('POST /api/characters', async (request: NextRequest) => {
  const body = await request.json();
  const { name, project_id, story_stack_id, type, faction_id, faction_hierarchy_node_id, voice, avatar_url, appearance } = body;
  ...
  if (faction_hierarchy_node_id) insertData.faction_hierarchy_node_id = faction_hierarchy_node_id;
