 ...
 */
export const GET = withApiHandler('GET /api/factions/[id]', async (request: NextRequest, context) => {
 ...
 * Update a faction
 */
export const PUT = withApiHandler('PUT /api/factions/[id]', async (request: NextRequest, context) => {
  const { id } = await context.params;
 ...
 */
export const DELETE = withApiHandler('DELETE /api/factions/[id]', async (request: NextRequest, context) => {
  const { id } = await context.params;
