...
const ProjectCardSkeleton: React.FC<ProjectCardSkeletonProps> = ({ index }) => {
  return (
    <motion.div
      ...
      className="group relative bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-lg p-6 overflow-hidden"
    ...
    >
      ...
      <div className="flex items-start gap-4">
        {/* Icon skeleton */}
        <div className="p-3 bg-slate-700/50 rounded-lg animate-pulse">
        ...
        <div className="flex-1 space-y-3">
          ...
          <div className="space-y-2">
            ...
            <div className="h-3 bg-slate-700/30 rounded animate-pulse w-5/6" />
          </div>
        </div>
      </div>
    </motion.div>
