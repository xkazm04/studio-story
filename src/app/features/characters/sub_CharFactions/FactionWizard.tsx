  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative bg-slate-900 rounded-lg border border-slate-800 p-6 max-w-4xl w-full max-h-[90vh] overflow-y-auto"
      >
          ...
          <div className="flex gap-2">
            <div
              className={cn('flex-1 h-1 rounded-full transition-colors',
                getStepNumber() >= 1 ? 'bg-purple-500' : 'bg-slate-700'
              )}
            />
            <div
              className={cn('flex-1 h-1 rounded-full transition-colors',
                getStepNumber() >= 2 ? 'bg-purple-500' : 'bg-slate-700'
              )}
            />
            <div
              className={cn('flex-1 h-1 rounded-full transition-colors',
                getStepNumber() >= 3 ? 'bg-purple-500' : 'bg-slate-700'
              )}
            />
          </div>
        </div>
