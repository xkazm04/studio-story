  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative bg-slate-900 rounded-lg border border-slate-800 p-6 max-w-lg w-full"
      >
        <ColoredBorder color="blue" />

        <div className="flex justify-between items-center mb-6">
          <h3 className="ms-h2">Create New Faction</h3>
          <button
            type="button"
            onClick={onClose}
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-slate-900 text-slate-400">or create manually</span>
          </div>
        </div>
        ...
        {rollbackError && (
          ...
          >
            ...
            <div>
              ...
              <div className="text-sm text-orange-300 mt-1">{rollbackError}</div>
            </div>
          </motion.div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-3 pt-4">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 disabled:bg-slate-700 disabled:text-slate-400 text-white rounded-lg font-medium transition-colors"
