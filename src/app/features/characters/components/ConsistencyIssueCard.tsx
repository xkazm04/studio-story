...
const ConsistencyIssueCard: React.FC<ConsistencyIssueCardProps> = ({
  ...
  return (
    <div
      className={cn('relative bg-slate-900 rounded-lg border overflow-hidden', severityColors[issue.severity])}
      ...
      >
        ...
        <div className="flex-1 text-left">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className={cn('text-sm px-2 py-0.5 rounded', severityColors[issue.severity])}>
              {issue.severity}
            </span>
          ...
          >
            <div className="px-4 pb-4 space-y-4 border-t border-slate-800">
              ...
              <div className="bg-blue-500/5 border border-blue-500/10 rounded-lg p-3">
                ...
                <p className="text-sm text-slate-300">{issue.ai_reasoning}</p>
              </div>
              ...
              {issue.suggested_resolution && (
                <div className="bg-green-500/5 border border-green-500/10 rounded-lg p-3">
                  ...
                  <p className="text-sm text-slate-300">{issue.suggested_resolution}</p>
                </div>
              )}
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 bg-green-600 hover:bg-green-700 disabled:bg-slate-700 text-white text-sm rounded-lg transition-colors"
                ...
                <button
                  ...
                  disabled={isResolving}
                  className="flex items-center gap-2 px-3 py-2 bg-blue-600 hover:bg-blue-700 disabled:bg-slate-700 text-white text-sm rounded-lg transition-colors"
                ...
                <button
                  ...
                  disabled={isResolving}
                  className="flex items-center gap-2 px-3 py-2 bg-slate-700 hover:bg-slate-600 disabled:bg-slate-800 text-slate-300 text-sm rounded-lg transition-colors"
