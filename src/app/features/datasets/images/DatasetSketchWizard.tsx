...
import { fadeIn, scaleIn, slideInLeft, SLOW } from '@/lib/animations';
  ...
  return (
    ...
    >
      <motion.div
        ...
        animate="animate"
        exit="exit"
        className="relative w-full max-w-2xl max-h-[90vh] bg-slate-900 rounded-xl overflow-hidden flex flex-col"
              ...
              >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-4 py-3 bg-slate-950 border border-slate-700 rounded-lg text-slate-200 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-none"
                  />
                </div>
              ...
              >
                ...
                <div className="space-y-2 max-h-[40vh] overflow-y-auto pr-1">
                  {variations.map((v, i) => (
                    <div
                      key={v.id}
                      className="flex items-start gap-2 p-3 bg-slate-800 rounded-lg group"
                    >
                      <span className="text-sm text-slate-400 font-mono mt-1 min-w-[1.5rem]">
                        {i + 1}.
                      </span>
                      {editingId === v.id ? (
                        <div className="flex-1 flex flex-col gap-2">
                          <textarea
                            ...
                            rows={3}
                            className="w-full px-3 py-2 bg-slate-950 border border-slate-600 rounded text-sm text-slate-200 focus:outline-none focus:ring-1 focus:ring-purple-500 resize-none"
                          />
