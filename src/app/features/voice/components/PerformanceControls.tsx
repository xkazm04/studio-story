...
function CompactSlider({ label, value, onChange, min = 0, max = 100, unit = '%' }: {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      />
      <span className="text-sm text-voice-accent font-mono w-8 text-right">{value}{unit}</span>
    </div>
  );
}
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isActive
                    ? 'bg-voice-accent/15 ring-1 ring-voice-accent/40 scale-105'
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isActive
                    ? 'bg-voice-accent/20 text-voice-accent ring-1 ring-voice-accent/30'
        ...
        <div className="shrink-0 p-3 mt-auto">
          <button
            ...
            className={cn(
              ...
              isGenerating
                ? 'bg-voice-accent/40 text-voice-accent/80 cursor-not-allowed'
