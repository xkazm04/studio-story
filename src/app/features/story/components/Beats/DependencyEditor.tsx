...
function DependencyCard({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'flex items-center gap-3 p-3 cursor-pointer', INTERACTIVE.row,
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mt-0.5">
            ...
            <span className="text-sm px-1.5 py-0.5 rounded" style={{
        ...
        {!readonly && (
          <div className="flex items-center gap-1">
            <button
              ...
              className={cn('p-1.5 rounded text-slate-400', INTERACTIVE.dangerHover, INTERACTIVE.transition)}
            >
          ...
          >
            <div className="p-3 space-y-3">
              ...
              <div className="space-y-1.5">
                <label className="text-sm text-slate-400">Dependency Type</label>
                ...
                <div className="flex gap-1">
                  {(Object.entries(STRENGTH_LEVELS) as [DependencyStrength, typeof STRENGTH_LEVELS.required][]).map(([strength, info]) => (
                    <button
                      ...
                      className={cn(
                        'flex-1 px-2 py-1.5 rounded text-sm', INTERACTIVE.transition, 'border',
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-slate-700">
          ...
          <button
            onClick={onClose}
            className={cn('p-1.5 rounded text-slate-400', INTERACTIVE.control)}
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="flex justify-end gap-2 p-4 border-t border-slate-700">
          <button
            onClick={onClose}
            className={cn('px-4 py-2 rounded-lg text-sm text-slate-300', INTERACTIVE.control)}
          >
            Cancel
          </button>
          <button
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        {!readonly && (
          <button
            ...
            className={cn('flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm bg-cyan-600/20 text-cyan-400 hover:bg-cyan-600/30', INTERACTIVE.transition)}
          >
          ...
          <div className="flex rounded-lg bg-slate-800/50 border border-slate-700/50 p-0.5">
            {(['all', 'incoming', 'outgoing'] as const).map((f) => (
              <button
                ...
                onClick={() => setFilter(f)}
                className={cn(
                  'px-3 py-1 rounded text-sm font-medium', INTERACTIVE.transition, 'capitalize',
                  filter === f
              ...
              >
                ...
                {f === 'incoming' && stats.incoming > 0 && (
                  <span className="ml-1 text-slate-400">({stats.incoming})</span>
                )}
                {f === 'outgoing' && stats.outgoing > 0 && (
                  <span className="ml-1 text-slate-400">({stats.outgoing})</span>
                )}
              </button>
            ))}
          </div>
        ...
        {filteredDependencies.length === 0 && (
          <div className="text-center py-8 text-slate-400 text-sm">
            ...
            {!readonly && (
              <button
                onClick={() => setShowAddDialog(true)}
                className={`mt-2 text-cyan-400 hover:text-cyan-300 ${INTERACTIVE.transition}`}
              >
      ...
      {validationErrors.length === 0 && dependencies.length > 0 && (
        <div className="flex items-center gap-2 p-2 bg-green-500/10 border border-green-500/30 rounded-lg">
          ...
          <span className="text-sm text-green-300">All dependencies valid</span>
        </div>
      )}
