...
const ActRecommendations = ({ recommendations, overallAssessment, onClose, onApply }: Props) => {
    ...
    const handleApprove = async (recommendation: ActRecommendation) => {
        ...
        try {
            ...
            showToast('Failed to apply recommendation. Try Again.', 'error', 5000);
        } finally {
        ...
        return (
            ...
            >
                <div className="flex items-start gap-3">
                    ...
                    <button
                        onClick={onClose}
                        className={`text-green-400 hover:text-green-300 ${INTERACTIVE.transition}`}
                    >
                        <X className="w-4 h-4" />
                    </button>
                </div>
        ...
        >
            ...
            <div className="flex items-start justify-between gap-3">
                ...
                <button
                    ...
                    className={`text-blue-400 hover:text-blue-300 ${INTERACTIVE.transition}`}
                >
                    <X className="w-4 h-4" />
                </button>
            </div>
                            ...
                            <div className="flex items-start gap-2 mb-2">
                                ...
                                <div className="flex-1">
                                    <div className="flex items-center gap-2 mb-1">
                                        ...
                                        {isApplied && (
                                            <span className="text-sm px-1.5 py-0.5 rounded bg-green-900/40 text-green-300">
                                                ✓ Applied
                                            </span>
                                        )}
                                    </div>
                                    ...
                                    {rec.change_type === 'add' && (
                                        <div className="bg-green-900/20 border border-green-700/30 rounded px-2 py-1 text-sm">
                                            <span className="text-green-300 font-mono">+ </span>
                                            <span className="text-green-200/80">{rec.after}</span>
                                        </div>
                                    )}
