...
import { Palette, Trash2, Eye, EyeOff, Sparkles, ChevronDown, FileText, ChevronsUpDown } from 'lucide-react';
...
export function ImagePromptComposer({ isGenerating = false, onImageSelect }: ImagePromptComposerProps) {
  ...
  return (
    <>
      {/* Header actions injected via headerActions pattern isn't needed —
          we render both header controls and body in this component */}
      <div className="shrink-0 px-4 py-3 border-b border-slate-800 bg-slate-900/80">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className={TYPOGRAPHY.h1}>Image Prompt Builder</h2>
